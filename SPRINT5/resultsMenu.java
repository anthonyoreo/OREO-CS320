...
//
//
    private Label patientName, date, overallScore, maxScore, minScore, auditoryProcessing, problemSolving, reasoning, memory, pragmatic, slpNotes;
...
//
        ...
        public Pane resultsPane (paneController paneController){
            ...
            patientInfo[0] = patientNameIn;
            patientInfo[1] = dtf.format(localDate);
            patientInfo[2] = String.valueOf(maxResult);
            patientInfo[3] = String.valueOf(minResult);
            ...
            Label[] scoresTotalarr = {patientName, date, maxScore, minScore};
            String[] scoresTotalStringarr = {"patientName: ", "date: ", "maxScore: ", "minScore: "};

            for (int scoresTotal = 0; scoresTotal < 4; scoresTotal++)
            {
